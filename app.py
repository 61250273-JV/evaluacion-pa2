...
st.markdown("### Desarrollado por: [Tu Nombre Apellido] - Código ISIL: [Tu Código]")
st.markdown("🔗 **[Enlace a mi cuaderno de Google COLAB](Pega_aqui_tu_enlace_de_compartir_en_modo_lector)**")
st.markdown("---")
